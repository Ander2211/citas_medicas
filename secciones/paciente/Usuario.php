        ...
        <div class="container-fluid">
            ...
            <div class="d-flex flex-grow-1 collapse navbar-collapse ms-4" id="navbarSupportedContent">
                ...
                <ul class="nav justify-content-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-light" aria-current="page" href="../../controladores/cerrar_sesion.php"><button type="button"
                                class="btn btn-dark" style="background-color: #011526;">Cerrar Sesion</button></a>
                    </li>
                </ul>
